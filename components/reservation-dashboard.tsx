...
import { BookmarkPlus, Package, RefreshCw, Search, Calendar, FileText } from 'lucide-react'
              ...
              <TabsContent value="items" className="space-y-4">
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="rounded-lg border bg-card overflow-hidden max-h-[420px] overflow-y-auto">
